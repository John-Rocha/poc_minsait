...
import 'package:poc_minsait/src/features/auth/presentation/pages/cubits/signup/signup_cubit.dart';
        ...
        child: ConstrainedBox(
          constraints: BoxConstraints(
            minHeight: MediaQuery.of(context)
                .size
                .height, // Garante altura mínima da tela
          ),
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      errorText: switch (state.password.displayError) {
                        PasswordValidationError.empty => 'Campo é obrigatório',
                      ...
                      Column(
                        children: [
                          CustomElevatedButton(
                            ...
                            onPressed: state.isSignupValid || state.isLoginValid
                                ? () {
                                    if (_isLogin) {
